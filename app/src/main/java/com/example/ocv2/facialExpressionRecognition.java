...
//                    1,3,new Scalar(144,238,144,150),2);
            curr_emotion_s = emotion_s;


            //             input/output    text: Angry (2.934234)
            Imgproc.putText(mat_image,emotion_s,
                    new Point((int)faceArray[i].tl().x,(int)faceArray[i].tl().y-10),
                    1,3,new Scalar(255,255,0,150),4);
